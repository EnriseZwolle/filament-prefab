...
namespace EnriseZwolle\FilamentPrefab\Console;
...
{
    protected $signature = 'prefab:filament
...
//            'pages' => [
//                [
//                    'title' => 'Job alert bevestigd',
//                    'label' => 'job-alert-confirmed',
//                    'type' => 'page',
//                ],
//                [
//                    'title' => 'Uitgeschreven',
//                    'label' => 'job-alert-unsubscribe',
//                    'type' => 'page',
//                ],
//            ],
//        ],
...
//    ];
     ...
     * @return void
     */
    protected function prefabBundle(string $bundle): void
    {
        if (!in_array($bundle, $this->getAvailableBundles())) {
            $this->error("Bundle `{$bundle}` not available.");
            return;
        }

        foreach ($this->getModulesFromBundle($bundle) as $module) {
            $this->prefabModule($module);
        }

        $this->info("Prefab of bundle `{$bundle}` was successful.");
        $this->comment('Please execute the "npm install && npm run dev" command to build your assets.');
    }
...
//    }
    ...
    protected function executeModuleCustomCommands(string $module): void
    {
        ...
        app("EnriseZwolle\FilamentPrefabStubs\Modules\\" . Str::studly($module) . "\ModuleActions")->execute();
    }
